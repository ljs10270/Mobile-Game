...
public class RankShowManager : MonoBehaviour
{
    public Text rank1UI;
    public Text rank2UI;
    public Text rank3UI;
        ...
        reference.OrderByChild("~~~").GetValueAsync().ContinueWith(
            task => {
                ...
                if (task.IsCompleted) //성공적으로 데이터를 task로 가져왔다면
                {
                    ...
                    rank1UI.text = "1위: 플레이 한 사용자가 없습니다.";
                    rank2UI.text = "2위: 플레이 한 사용자가 없습니다.";
                    rank3UI.text = "3위: 플레이 한 사용자가 없습니다.";
                    rank4UI.text = "4위: 플레이 한 사용자가 없습니다.";
                    rank5UI.text = "5위: 플레이 한 사용자가 없습니다.";
